    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Login successful, store token and navigate to project list page
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl bg-gradient-to-br from-white to-gray-50">
                ...
                <div className="text-center">
                    <p className="text-sm text-gray-600">
                        ...
                        <a href="/register" className="font-medium text-indigo-600 hover:text-indigo-500 transition duration-300">
                            Register here
                        </a>
                    </p>
                </div>
